    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      <div>
        ...
        <div class="mb-5" role="alert">
          ...
          <div class="border border-t-0 border-red-400 rounded-b bg-red-100 px-4 text-red-700">
            <p>
              <ul>
        ...
        <form action="{{ route('food.store') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="flex flex-wrap -mx-3 mb-6">
            <div class="w-full px-3">
              ...
              <p class="text-gray-600 text-xs italic">Dipisahkan dengan koma, contoh: Bawang Merah, Paprika, Bawang
                Bommbay</p>
            </div>
          </div>
          <div class="flex flex-wrap -mx-3 mb-6">
